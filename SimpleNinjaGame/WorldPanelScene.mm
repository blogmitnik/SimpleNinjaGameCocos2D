...
#include "WorldPanelScene.h"
#import "NMPanelMenu.h"
#import "NMPanelMenuItem.h"
#import "TouchDelegatingView.h"


@implementation WorldPanelScene

+(id) scene
{
    CCScene *scene = [CCScene node];
	WorldPanelScene *layer = [WorldPanelScene node];
...
- (void) onEnter 
{
    ...
    { // background
        CCSprite* bg = [CCSprite spriteWithFile:@"wood-background.png"];
    ...
    // positioned on the level they left.
